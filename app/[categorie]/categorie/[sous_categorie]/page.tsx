  ...
  return (
    <main style={{ background: "#fdf8f2", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "56px clamp(20px, 4vw, 48px) 0" }}>
        <div style={{ fontSize: "12px", fontWeight: 700, display: "flex", alignItems: "center", gap: "8px", marginBottom: "20px", flexWrap: "wrap" as const, fontFamily: "'Nunito', sans-serif" }}>
      ...
      {vedette && (
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px clamp(20px, 4vw, 48px) 0" }}>
          <div style={{ fontSize: "11px", fontWeight: 800, color: "#bf3e0f", textTransform: "uppercase" as const, letterSpacing: "2px", marginBottom: "16px", fontFamily: "'Nunito', sans-serif" }}>✦ Article à la une</div>
          <div style={{ display: "grid", borderRadius: "20px", overflow: "hidden", border: "1px solid #f0d4b8", background: "white" }} className="vedette-grid">
            ...
            <div style={{ padding: "40px", display: "flex", flexDirection: "column" as const, justifyContent: "space-between" }}>
              <div>
                <h2 style={{ fontFamily: "'Rammetto One', cursive", fontSize: "24px", color: "#731702", lineHeight: 1.2, marginBottom: "16px" }}>{vedette.titre}</h2>
                <p style={{ fontSize: "15px", color: "#9a6040", lineHeight: 1.8, marginBottom: "24px", fontFamily: "'Nunito', sans-serif" }}>{vedette.extrait}</p>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "11px", color: "#9a6040", fontFamily: "'Nunito', sans-serif" }}>{vedette.temps_lecture && `${vedette.temps_lecture} min · `}{vedette.date}</div>
                  </div>
                </div>
                <a href={`/${categorie}/${vedette.slug}`} style={{ background: "#731702", color: "white", fontFamily: "'Nunito', sans-serif", fontSize: "13px", fontWeight: 800, padding: "11px 22px", borderRadius: "8px", textDecoration: "none" }}>Lire →</a>
              </div>
            </div>
          </div>
        </div>
      ...
      {reste.length > 0 && (
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px clamp(20px, 4vw, 48px) 64px" }}>
          <h2 style={{ fontFamily: "'Rammetto One', cursive", fontSize: "22px", color: "#731702", marginBottom: "24px", paddingBottom: "16px", borderBottom: "1px solid #f0d4b8" }}>Tous les articles</h2>
            ...
            {reste.map((article: any) => (
              <a key={article.slug} href={`/${categorie}/${article.slug}`} style={{ textDecoration: "none" }}>
                <div style={{ background: "white", borderRadius: "14px", border: "1px solid #f0d4b8", overflow: "hidden", height: "100%" }}>
                  <div style={{ height: "160px", background: "#bf3e0f", position: "relative" as const, overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "52px" }}>
                    ...
                    <span style={{ position: "absolute" as const, top: "12px", left: "12px", zIndex: 2, background: "rgba(255,255,255,0.92)", color: "#bf3e0f", fontSize: "9px", fontWeight: 800, padding: "3px 10px", borderRadius: "20px", textTransform: "uppercase" as const, fontFamily: "'Nunito', sans-serif" }}>{sousCategorieLabel}</span>
                  </div>
                  <div style={{ padding: "18px 20px" }}>
                    <h3 style={{ fontFamily: "'Rammetto One', cursive", fontSize: "15px", color: "#731702", lineHeight: 1.3, marginBottom: "8px" }}>{article.titre}</h3>
                    <p style={{ fontSize: "12px", color: "#9a6040", lineHeight: 1.6, marginBottom: "14px", fontFamily: "'Nunito', sans-serif" }}>{article.extrait}</p>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: "12px", borderTop: "1px solid #f0d4b8" }}>
                      ...
                      <span style={{ fontSize: "11px", color: "#bf3e0f", fontWeight: 700, fontFamily: "'Nunito', sans-serif" }}>{article.temps_lecture ? `${article.temps_lecture} min →` : "Lire →"}</span>
                    </div>
                  </div>
                </div>
              </a>
      ...
      {!articles?.length && (
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px clamp(20px, 4vw, 48px)", textAlign: "center" as const }}>
          <p style={{ fontFamily: "'Rammetto One', cursive", fontSize: "24px", color: "#f0d4b8", marginBottom: "16px" }}>Articles à venir bientôt...</p>
          <a href={`/${categorie}`} style={{ fontSize: "14px", fontWeight: 700, color: "#bf3e0f", textDecoration: "none", fontFamily: "'Nunito', sans-serif" }}>← Retour à {categorieLabel}</a>
        </div>
      )}
