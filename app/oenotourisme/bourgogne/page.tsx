        ...
        <div style={{ display: "grid", gap: "56px", alignItems: "start" }} className="content-layout">
          ...
          <div className="sommaire-desktop" style={{ position: "sticky", top: "88px", paddingTop: "64px" }}>
            ...
            <div style={{ background: "#731702", borderRadius: "14px", padding: "20px", marginTop: "16px", textAlign: "center" as const }}>
              ...
              <a href="https://www.winalist.fr/france/bourgogne?utm_medium=affiliate-ae&utm_campaign=le-petit-vigneron&utm_source=affiliate-ae&ae=158" target="_blank" rel="noopener noreferrer nofollow" style={{ display: "block", background: "#f28322", color: "#ffffff", fontFamily: "'Nunito', sans-serif", fontSize: "13px", fontWeight: 800, padding: "10px 16px", borderRadius: "8px", textDecoration: "none" }}>
