...
export default async function OenotourismeBourgogne() {
  ...
  const routes = [
    { label: "Chablis & Grand Auxerrois", desc: "Berceau des blancs vifs et minéraux produits à 100 % en Chardonnay. Les carrières de Kimméridgien donnent au Chablis son caractère unique et calcaire.", cepages: "Chardonnay · Blancs secs" },
    { label: "Côte de Nuits", desc: "De Dijon à Nuits-Saint-Georges, c'est ici que naissent les plus grands vins rouges du monde : Chambertin, Musigny, Romanée-Conti.", cepages: "Pinot Noir · Grands Crus" },
    { label: "Côte de Beaune", desc: "Beaune, capitale des vins de Bourgogne, rayonne entre Corton, Meursault et Montrachet. Blancs secs d'exception et rouges élégants y cohabitent.", cepages: "Pinot Noir & Chardonnay" },
    { label: "Côte Chalonnaise & Mâconnais", desc: "Plus accessibles et tout aussi séduisants : Givry, Rully, Pouilly-Fuissé. Vignobles autour des Roches de Solutré pour des paysages sculptés.", cepages: "Excellent rapport qualité-prix" },
  ]

  const experiences = [
    { titre: "Escapade en side-car vintage dans les vignes", chateau: "Rétro Tour Bourgogne", prix: "58–85 €", desc: "Balade dans la Côte de Beaune à bord d'un side-car vintage, avec dégustation. Une façon totalement insolite de parcourir les Grands Crus.", img: "https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20bourgogne/retro%20tour%20bourgogne.webp", lien: "https://www.winalist.fr/hosts/1084/retro-tour-bourgogne?utm_medium=affiliate-ae&utm_campaign=le-petit-vigneron&utm_source=affiliate-ae&ae=158", profil: "Insolite" },
    { titre: "Vol en montgolfière avec un vigneron", chateau: "Art Montgolfière Bourgogne", prix: "240 €", desc: "Un vigneron de Mercurey vous emmène survoler les vignobles de Bourgogne en montgolfière. Une expérience unique mêlant passion du ciel et du vin.", img: "https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20bourgogne/mongolfiere.webp", lien: "https://www.winalist.fr/hosts/1099/art-montgolfiere-bourgogne?utm_medium=affiliate-ae&utm_campaign=le-petit-vigneron&utm_source=affiliate-ae&ae=158", profil: "Luxe" },
    { titre: "Dégustation Vins & Chocolats", chateau: "Château de Chamirey — Mercurey", prix: "", desc: "Accord original entre les vins du domaine et des chocolats fins, dans un cadre de château exceptionnel. Note de 4,8/5 sur 232 avis.", img: "https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20bourgogne/Chateau%20chamirey.webp", lien: "https://www.winalist.fr/hosts/166/chateau-de-chamirey?utm_medium=affiliate-ae&utm_campaign=le-petit-vigneron&utm_source=affiliate-ae&ae=158", profil: "Débutant" },
    { titre: "Dégustation à l'aveugle en Bourgogne", chateau: "Domaine de Cardon — Rully", prix: "", desc: "Atelier dégustation à l'aveugle pour tester et affûter votre palais sur des vins bourguignons, dans un domaine bio en Côte Chalonnaise.", img: "https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20bourgogne/Degustation%20a%20l'aveugle.webp", lien: "https://www.winalist.fr/hosts/1188/domaine-de-cardon?utm_medium=affiliate-ae&utm_campaign=le-petit-vigneron&utm_source=affiliate-ae&ae=158", profil: "Passionné" },
    { titre: "Devenez vigneron d'un jour", chateau: "Domaine Joseph Lafarge — Mâconnais", prix: "49–99 €", desc: "Immersion complète dans le travail du vigneron au cœur du Mâconnais, avec cours d'œnologie et dégustation privilège.", img: "https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20bourgogne/Vigneron%20d'un%20jour.webp", lien: "https://www.winalist.fr/hosts/1080/domaine-joseph-lafarge?utm_medium=affiliate-ae&utm_campaign=le-petit-vigneron&utm_source=affiliate-ae&ae=158", profil: "Passionné" },
  ]
  ...
  const faq = [
    { q: "Quel est le meilleur endroit pour débuter l'oenotourisme en Bourgogne ?", r: "Beaune est le point de départ idéal : ville historique au cœur de la Côte de Beaune, elle concentre hôtels de charme, restaurants gastronomiques, caves à visiter (notamment les Hospices) et un office du tourisme très bien organisé pour les amateurs de vin." },
    { q: "Faut-il être expert en vin pour profiter de l'oenotourisme bourguignon ?", r: "Absolument pas. La grande majorité des domaines et prestataires proposent des expériences adaptées à tous les niveaux, des grands débutants aux connaisseurs confirmés. L'essentiel est la curiosité et l'envie de découverte." },
    { q: "Quelles appellations bourguignonnes sont les plus connues ?", r: "Parmi les plus emblématiques : Romanée-Conti, Chambertin, Musigny, Chablis Grand Cru, Meursault, Puligny-Montrachet, Pouilly-Fuissé. Ces noms sont des références mondiales pour les amateurs de vin." },
    { q: "L'oenotourisme en Bourgogne est-il adapté aux familles ?", r: "Oui, avec un programme équilibré : balades vélo accessibles, villages médiévaux, marchés locaux, activités nature autour des vignobles. Les enfants peuvent participer à des ateliers jus de raisin pendant les vendanges." },
  ]
    ...
    <main style={{ background: "#fdf8f2", minHeight: "100vh" }}>
        ...
        <div style={{ display: "grid", gap: "56px", alignItems: "start" }} className="content-layout">
          <div>
            ...
            <div style={{ paddingTop: "64px" }}>
              ...
              <p style={{ fontSize: "17px", color: "#4a2010", lineHeight: 1.9, marginBottom: "24px", fontFamily: "'Nunito', sans-serif" }}>
                L'oenotourisme bourguignon, c'est à la fois la visite de caves voûtées du XIIe siècle, les dégustations de Pinot Noir et de Chardonnay directement chez le vigneron, les balades vélo au fil de la Route des Grands Crus, et les repas de terroir accompagnés des meilleures appellations locales.
              </p>
              <div style={{ borderRadius: "16px", overflow: "hidden", margin: "40px 0", border: "1px solid #f0d4b8" }}>
                <img src="https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20bourgogne/vignobles%20Cote%20de%20Nuits%20Bourgogne%20automne%20oenotourisme.webp" alt="Vignobles Côte de Nuits Bourgogne automne" style={{ width: "100%", height: "400px", objectFit: "cover", display: "block" }} />
              </div>
            </div>
            ...
            <div style={{ paddingTop: "16px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column" as const, gap: "16px", marginBottom: "40px" }}>
                {routes.map((r, i) => (
                  <div key={i} style={{ background: "white", borderRadius: "12px", border: "1px solid #f0d4b8", padding: "20px 24px", display: "flex", gap: "16px", alignItems: "flex-start" }}>
                    <div style={{ width: "32px", height: "32px", borderRadius: "50%", background: "#ffe7ca", border: "1px solid #f0d4b8", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Rammetto One', cursive", fontSize: "13px", color: "#bf3e0f" }}>{String(i + 1)}</div>
                    <div style={{ flex: 1 }}>
              ...
              <div style={{ borderRadius: "16px", overflow: "hidden", margin: "40px 0", border: "1px solid #f0d4b8" }}>
                <img src="https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20bourgogne/velo%20route%20des%20Grands%20Crus%20Cote%20de%20Nuits%20Bourgogne.webp" alt="Vélo Route des Grands Crus Côte de Nuits Bourgogne" style={{ width: "100%", height: "400px", objectFit: "cover", display: "block" }} />
              </div>
            </div>
            ...
            <div style={{ paddingTop: "16px" }}>
                ...
                {experiences.map((exp, i) => (
                  <div key={i} style={{ background: "white", borderRadius: "16px", border: "1px solid #f0d4b8", overflow: "hidden", display: "grid" }} className="exp-card">
                    <div style={{ height: "220px", overflow: "hidden", position: "relative" as const }}>
                      ...
                      <span style={{ position: "absolute" as const, top: "14px", left: "14px", background: profilColors[exp.profil]?.bg || "#ffe7ca", color: profilColors[exp.profil]?.color || "#bf3e0f", fontSize: "10px", fontWeight: 800, padding: "4px 12px", borderRadius: "20px", textTransform: "uppercase" as const, letterSpacing: "0.5px", fontFamily: "'Nunito', sans-serif" }}>{exp.profil}</span>
                      {exp.prix && (<span style={{ position: "absolute" as const, top: "14px", right: "14px", background: "white", color: "#731702", fontSize: "11px", fontWeight: 800, padding: "4px 12px", borderRadius: "20px", fontFamily: "'Nunito', sans-serif" }}>{exp.prix}</span>)}
                    </div>
              ...
              <div style={{ background: "#ffe7ca", borderRadius: "12px", padding: "20px 24px", border: "1px solid #f0c49a", marginBottom: "56px" }}>
                <p style={{ fontSize: "14px", color: "#731702", lineHeight: 1.7, fontWeight: 600, fontFamily: "'Nunito', sans-serif", margin: 0 }}>
                  Bon à savoir : Le label Vignobles & Découvertes garantit une offre oenotouristique de qualité. En Bourgogne, 812 prestataires ont été certifiés — hébergements, restaurants, caves et activités.
                </p>
              </div>
              <div style={{ borderRadius: "16px", overflow: "hidden", margin: "0 0 56px", border: "1px solid #f0d4b8" }}>
                <img src="https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20bourgogne/degustation%20vin%20rouge%20Bourgogne%20cave%20vigneron%20oenotourisme.webp" alt="Dégustation vin rouge Bourgogne cave vigneron" style={{ width: "100%", height: "360px", objectFit: "cover", display: "block" }} />
              </div>
            </div>
            ...
            <div style={{ paddingTop: "16px" }}>
              ...
              <p style={{ fontSize: "17px", color: "#4a2010", lineHeight: 1.9, marginBottom: "32px", fontFamily: "'Nunito', sans-serif" }}>
                La Bourgogne se visite toute l'année, mais chaque saison offre une expérience différente.
              </p>
            ...
            <div style={{ paddingTop: "16px" }}>
              ...
              <div style={{ borderRadius: "16px", overflow: "hidden", margin: "0 0 56px", border: "1px solid #f0d4b8" }}>
                <img src="https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20bourgogne/repas%20gastronomique%20domaine%20viticole%20Bourgogne%20oenotourisme.webp" alt="Repas gastronomique domaine viticole Bourgogne" style={{ width: "100%", height: "360px", objectFit: "cover", display: "block" }} />
              </div>
            </div>
          ...
          <div className="sommaire-desktop" style={{ position: "sticky", top: "88px", paddingTop: "64px" }}>
            <div style={{ background: "white", border: "1px solid #f0d4b8", borderRadius: "14px", overflow: "hidden" }}>
              ...
              <nav style={{ padding: "8px 0" }}>
                {[
                  ...
                  { anchor: "articles", label: "Nos articles Bourgogne" },
                ].map((item, i, arr) => (
            ...
            <div style={{ background: "#731702", borderRadius: "14px", padding: "20px", marginTop: "16px", textAlign: "center" as const }}>
              <p style={{ fontSize: "13px", fontWeight: 800, color: "#ffffff", fontFamily: "'Nunito', sans-serif", marginBottom: "12px" }}>Toutes nos expériences Bourgogne sur Winalist</p>
        ...
        <section id="articles" style={{ background: "#ffe7ca", padding: "72px clamp(20px, 4vw, 48px)", scrollMarginTop: "90px" }}>
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <div style={{ marginBottom: "40px" }}>
              <span style={{ display: "inline-block", background: "#f28322", color: "#ffffff", fontSize: "11px", fontWeight: 800, padding: "4px 14px", borderRadius: "20px", marginBottom: "12px", textTransform: "uppercase" as const, letterSpacing: "1px", fontFamily: "'Nunito', sans-serif" }}>Nos articles</span>
              <h2 style={{ fontFamily: "'Rammetto One', cursive", fontSize: "clamp(24px, 3vw, 36px)", color: "#731702", margin: 0 }}>
                Tout savoir sur l'oenotourisme en Bourgogne
              </h2>
            </div>
                ...
                <a key={article.slug} href={`/oenotourisme/${article.slug}`} style={{ textDecoration: "none" }}>
                  <div style={{ background: "white", borderRadius: "16px", border: "1px solid #f0d4b8", overflow: "hidden", height: "100%", transition: "transform 0.2s, box-shadow 0.2s" }} className="article-card">
                    ...
                    <div style={{ padding: "20px" }}>
                      <h3 style={{ fontFamily: "'Rammetto One', cursive", fontSize: "16px", color: "#731702", marginBottom: "10px", lineHeight: 1.3 }}>{article.titre}</h3>
                      {article.extrait && (
      ...
      <section style={{ background: "#731702", padding: "72px clamp(20px, 4vw, 48px)" }}>
        <div style={{ maxWidth: "700px", margin: "0 auto", textAlign: "center" as const }}>
          <h2 style={{ fontFamily: "'Rammetto One', cursive", fontSize: "clamp(24px, 3vw, 36px)", color: "#ffffff", marginBottom: "16px" }}>Prêt à découvrir la Bourgogne ?</h2>
          ...
          <div style={{ display: "flex", gap: "12px", justifyContent: "center" as const, flexWrap: "wrap" as const }}>
            ...
            <a href="/oenotourisme/bordeaux" style={{ background: "transparent", color: "#ffffff", fontFamily: "'Nunito', sans-serif", fontSize: "14px", fontWeight: 700, padding: "13px 26px", borderRadius: "8px", border: "1.5px solid rgba(255,255,255,0.4)", textDecoration: "none" }}>Bordeaux</a>
