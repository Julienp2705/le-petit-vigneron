...
export default async function OenotourismeChampagne() {
  ...
  const zones = [
    { label: "Montagne de Reims", desc: "Au cœur d'un Parc naturel régional, les coteaux de Verzenay et Verzy offrent des panoramas à 360° sur les vignes. Patrie du Pinot Noir. À ne pas manquer : le Phare de Verzenay, insolite vigie au milieu des vignobles.", cepages: "Pinot Noir · Vins structurés" },
    { label: "Vallée de la Marne", desc: "De Châlons à Épernay, les vignes de Pinot Meunier s'étendent sur des coteaux généreux. Hautvillers, berceau de Dom Pérignon, et l'Avenue de Champagne d'Épernay sont les étapes emblématiques.", cepages: "Pinot Meunier · Bulles festives" },
    { label: "Côte des Blancs", desc: "Au sud d'Épernay, cette zone est le territoire exclusif du Chardonnay. Avize, Cramant, Le Mesnil-sur-Oger : des noms légendaires pour des Blancs de Blancs d'une finesse incomparable.", cepages: "Chardonnay · Blancs de Blancs" },
    { label: "Côte des Bar (Aube)", desc: "La grande oubliée des itinéraires, pourtant l'une des plus attachantes. Vignerons indépendants passionnés, paysages intimistes, et des champagnes en biodynamie de plus en plus reconnus.", cepages: "Pinot Noir · Vignerons artisans" },
  ]
  ...
  const experiences = [
    { titre: "Visite permanente Ruinart", chateau: "Champagne Ruinart — Reims", desc: "La plus ancienne maison de Champagne (1729) ouvre ses crayères gothiques pour une expérience ultra-immersive. Un incontournable absolu de l'oenotourisme champenois.", img: "https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20champagne/Ruinart%20visite.webp", lien: "https://www.winalist.fr/experiences/321/visite-permanente?utm_medium=affiliate-ae&utm_campaign=le-petit-vigneron&utm_source=affiliate-ae&ae=158", profil: "Luxe" },
    { titre: "Visite, Dégustation et Sabrage en Cave et Château", chateau: "Champagne Comtesse Lafond", desc: "Une expérience mémorable qui combine la visite des caves, la dégustation commentée et l'art du sabrage — la mise en scène parfaite pour vivre la Champagne à pleine effervescence.", img: "https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20champagne/Sabrage%20champagne.webp", lien: "https://www.winalist.fr/experiences/539/visite-degustation-et-sabrage-en-cave-et-chateau?utm_medium=affiliate-ae&utm_campaign=le-petit-vigneron&utm_source=affiliate-ae&ae=158", profil: "Insolite" },
    { titre: "Cépages & Senteurs : les arômes du Champagne", chateau: "Champagne Christian Muller", desc: "Un atelier sensoriel pour apprendre à identifier les arômes du Champagne à travers ses cépages. Une approche pédagogique et ludique, idéale pour affiner son palais.", img: "https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20champagne/cepages%20et%20senteurs.webp", lien: "https://www.winalist.fr/experiences/5224/cepages-senteurs-les-aromes-du-champagne?utm_medium=affiliate-ae&utm_campaign=le-petit-vigneron&utm_source=affiliate-ae&ae=158", profil: "Débutant" },
    { titre: "La route du Champagne en Combi VW", chateau: "Champagne Lévêque Dehan", desc: "Parcourez les routes de vignobles champenois à bord d'un Combi VW vintage, avec arrêts chez les vignerons et dégustation au fil du parcours. L'expérience la plus insolite de la région.", img: "https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20champagne/La%20route%20chmapagne%20combi%20vw.webp", lien: "https://www.winalist.fr/experiences/1981/la-route-du-champagne-en-combi-vw?utm_medium=affiliate-ae&utm_campaign=le-petit-vigneron&utm_source=affiliate-ae&ae=158", profil: "Insolite" },
    { titre: "Croisière Semi Privée en Champagne — 3h", chateau: "My House Boat", desc: "Une croisière de 3 heures sur la Marne au cœur du vignoble champenois, avec dégustation à bord. Le moyen le plus élégant de découvrir la Champagne depuis l'eau.", img: "https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20champagne/croisiere%20champagne.webp", lien: "https://www.winalist.fr/experiences/5317/croisiere-semi-prive-en-champagne-3-h?utm_medium=affiliate-ae&utm_campaign=le-petit-vigneron&utm_source=affiliate-ae&ae=158", profil: "Luxe" },
  ]
  ...
  const faq = [
    { q: "Faut-il être amateur de champagne pour apprécier l'oenotourisme champenois ?", r: "Absolument pas. L'oenotourisme en Champagne est accessible à tous. De nombreuses activités (visites de crayères, balades en vignoble) se vivent sans aucune connaissance préalable en oenologie." },
    { q: "Quelle est la différence entre Reims et Épernay pour l'oenotourisme ?", r: "Reims est la ville culturelle, avec la cathédrale, les crayères monumentales et une offre hôtelière et gastronomique plus étoffée. Épernay est la capitale du Champagne, plus viticole et concentrée. Les deux se complètent parfaitement." },
    { q: "Qu'est-ce qu'une crayère et pourquoi est-ce si spécial ?", r: "Les crayères sont d'anciennes carrières souterraines creusées dans la craie, utilisées depuis des siècles pour faire vieillir le champagne à température constante (10–12°C). Leur architecture gothique et l'atmosphère qui s'en dégage en font des lieux d'exception." },
    { q: "Les enfants peuvent-ils participer aux visites oenotouristiques ?", r: "Certaines activités comme les balades dans les vignes ou le tour en montgolfière conviennent parfaitement aux familles. Les dégustations proprement dites sont réservées aux adultes." },
  ]
    ...
    <main style={{ background: "#fdf8f2", minHeight: "100vh" }}>
        ...
        <div style={{ display: "grid", gap: "56px", alignItems: "start" }} className="content-layout">
          <div>
            ...
            <div style={{ paddingTop: "64px" }}>
              ...
              <p style={{ fontSize: "17px", color: "#4a2010", lineHeight: 1.9, marginBottom: "24px", fontFamily: "'Nunito', sans-serif" }}>
                Entre crayères souterraines labyrinthiques, vignobles panoramiques et villages de vignerons authentiques, la Champagne offre une expérience sensorielle et culturelle unique en France. La région se classe au 4e rang des destinations oenotouristiques françaises les plus visitées.
              </p>
              <div style={{ borderRadius: "16px", overflow: "hidden", margin: "40px 0", border: "1px solid #f0d4b8" }}>
                <img src="https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20champagne/Oenotourisme%20champagne.webp" alt="Oenotourisme Champagne vignobles" style={{ width: "100%", height: "400px", objectFit: "cover", display: "block" }} />
              </div>
            </div>
            ...
            <div style={{ paddingTop: "16px" }}>
              ...
              <div style={{ background: "#ffe7ca", borderRadius: "12px", padding: "20px 24px", border: "1px solid #f0c49a", marginBottom: "40px" }}>
                <p style={{ fontSize: "14px", color: "#731702", lineHeight: 1.7, fontWeight: 600, fontFamily: "'Nunito', sans-serif", margin: 0 }}>
                  Conseil pratique : Pour une expérience complète, combinez une grande Maison à Reims ou Épernay avec la visite d'un vigneron indépendant dans un village.
                </p>
              </div>
              <div style={{ borderRadius: "16px", overflow: "hidden", margin: "0 0 56px", border: "1px solid #f0d4b8" }}>
                <img src="https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20champagne/Cave%20champagne.webp" alt="Crayères Champagne cave souterraine" style={{ width: "100%", height: "400px", objectFit: "cover", display: "block" }} />
              </div>
            </div>
            ...
            <div style={{ paddingTop: "16px" }}>
              ...
              <p style={{ fontSize: "17px", color: "#4a2010", lineHeight: 1.9, marginBottom: "32px", fontFamily: "'Nunito', sans-serif" }}>
                La Champagne se visite toute l'année, mais les saisons offrent des expériences radicalement différentes.
              </p>
              ...
              <div style={{ background: "#ffe7ca", borderRadius: "12px", padding: "20px 24px", border: "1px solid #f0c49a", marginBottom: "40px" }}>
                <p style={{ fontSize: "14px", color: "#731702", lineHeight: 1.7, fontWeight: 600, fontFamily: "'Nunito', sans-serif", margin: 0 }}>
                  Le moment ultime : Les vendanges champenoises en septembre sont parmi les plus spectaculaires de France. Entièrement manuelles (exigence de l'AOC Champagne), elles mobilisent des dizaines de milliers de cueilleurs.
                </p>
              </div>
              <div style={{ borderRadius: "16px", overflow: "hidden", margin: "0 0 56px", border: "1px solid #f0d4b8" }}>
                <img src="https://ciwihnnhdiwfqtywviko.supabase.co/storage/v1/object/public/Oenotourisme%20champagne/Vendanges%20champagne.webp" alt="Vendanges manuelles Champagne" style={{ width: "100%", height: "360px", objectFit: "cover", display: "block" }} />
              </div>
            </div>
          ...
          <div className="sommaire-desktop" style={{ position: "sticky", top: "88px", paddingTop: "64px" }}>
            <div style={{ background: "white", border: "1px solid #f0d4b8", borderRadius: "14px", overflow: "hidden" }}>
              ...
              <nav style={{ padding: "8px 0" }}>
                {[
                  ...
                  { anchor: "articles", label: "Nos articles Champagne" },
                ].map((item, i, arr) => (
            ...
            <div style={{ background: "#731702", borderRadius: "14px", padding: "20px", marginTop: "16px", textAlign: "center" as const }}>
              <p style={{ fontSize: "13px", fontWeight: 800, color: "#ffffff", fontFamily: "'Nunito', sans-serif", marginBottom: "12px" }}>Toutes nos expériences Champagne sur Winalist</p>
          ...
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <div style={{ marginBottom: "40px" }}>
              ...
              <h2 style={{ fontFamily: "'Rammetto One', cursive", fontSize: "clamp(24px, 3vw, 36px)", color: "#731702", margin: 0 }}>
                Tout savoir sur l'oenotourisme en Champagne
              </h2>
            </div>
      ...
      <section style={{ background: "#731702", padding: "72px clamp(20px, 4vw, 48px)" }}>
        <div style={{ maxWidth: "700px", margin: "0 auto", textAlign: "center" as const }}>
          <h2 style={{ fontFamily: "'Rammetto One', cursive", fontSize: "clamp(24px, 3vw, 36px)", color: "#ffffff", marginBottom: "16px" }}>Prêt à découvrir la Champagne ?</h2>
